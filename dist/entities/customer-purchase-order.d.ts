...
export declare enum CustomerPurchaseOrderSource {
 ...
 */
export type CustomerPurchaseOrderConfirmation = 'pending_supplier_action' | 'confirmed' | 'partially_confirmed' | 'rejected';
/**
 ...
 */
export type FulfillmentReadiness = 'unmapped' | 'delivered' | 'ready' | 'partial' | 'short';
...
//# sourceMappingURL=customer-purchase-order.d.ts.map